		...
		<div class ="row">
		   <article class="col-md-9 maincontent right app_div marginTablet"  style ="margin-top:5px;margin-right: 5px;margin-left: 0px">
			   <div class="row">    
				...
				<div class ='col-md-3'>
					<img style ="border:1px solid gray" src ="assets/images/powerfm.png" width ="220"/>
				</div>
				<div class ='col-md-9'>
					<p>
						<a target = '_tab' href ="https://twitter.com/Powerfm987/status/1231110651046699008">#POWERWeekendBreakfast</a><br/>
						<span style= "color:gray;font-size:14px">Radio interview | February 22, 2020</span><br/>
						<b>PowerFM</b>. We reflect on #InternationalMotherLanguageDay unpacking the history and different dialects of Xitsonga with Hlulani Baloyi and Hlawuleka Maswanganyi who are part of http://Xitsonga.org.
					</p>
				</div>
			</div>
			<hr>
