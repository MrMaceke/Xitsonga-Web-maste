...
<html ng-app>
	...
	<meta name="author" content="Waxbill">
        ...
        <title>Timeline &HorizontalLine; ClientZone</title>
    </head>
    <body>
        <div>
        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
			<div class="content">
                            <div class="module"  ng-controller="userTasksController">
                                <div class="module-head"><h3>Timeline</h3></div>
                                <div class="module-body">
                                    <b></b>
                                    <br/><br/>
                                    <div ng-show="showLoader">
                                        <div style="height: 708px"></div>
                                    </div>
                                    <div id="timelineCalendar"></div>
                                </div>
                            </div>
                        </div>
                    </div>
