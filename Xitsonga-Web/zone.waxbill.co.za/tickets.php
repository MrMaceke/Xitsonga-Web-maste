...
<html ng-app>
	...
	<meta name="author" content="Waxbill">
        ...
        <title>Tickets &HorizontalLine; ClientZone</title>
    ...
    <body>
        ...
        <div class="wrapper">
			...
			<div class="content">
                            <div class="module">
                                <div class="module-head"><h3>Support Tickets</h3></div>
                                <div class="module-body" style="min-height: 600px">
                                    <div ng-controller="supportTicketsController">
                                        <div ng-show="showLoader">
                                            <div style="height: 400px"></div>
                                        </div>
                                        <br/>
                                        <table id = 'supportTable' class="table table-bordered" cellspacing="0" width="100%">
                                            <tbody></tbody>
                                        </table>
                                        <div ng-if="supportTickets.status === -999" ng-cloak>
