...
?>
<div class ='updatePropertyDialog' style="visibility: hidden">
    <br/><br/>
    <div class="module" style ="background: #F8F5F0">
        <div class="module-head"><h3>Update System Property</h3></div>
            ...
            <form method="get" class="form-horizontal row-fluid">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <button class="btn btn-primary" type="submit" onclick="updateSystemProperty(event)">Update System Property</button>
                    </div>
                </div>
            </form>
        </div>
