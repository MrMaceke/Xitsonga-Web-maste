...
?>
<div class ='addUserDialog' style ="visibility: hidden">
    <br/><br/>
    <div class="module" style ="background: #F8F5F0">
        <div class="module-head"><h3>Add System User</h3></div>
            ...
            <form method="get" class="form-horizontal row-fluid">
                ...
                <div ng-repeat="systemProperty in systemProperties" ng-if ="systemProperty.groupName === 'Client Basic'">
                    <div class="control-group">
                        ...
                        <div class="controls" style ="margin-top: 2px">
                            <input  id = "{{systemProperty.propertyId}}" type="text" class="form-control userDetails span8" placeholder="{{systemProperty.propertyName}}" alt ="{{systemProperty.propertyName}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls" style ="margin-top: 5px">
                        ...
                        <button class="btn btn-primary" type="submit" onclick="addNewSystemUser(event)">Add System User</button>
                    </div>
                </div>
            </form>
        </div>
