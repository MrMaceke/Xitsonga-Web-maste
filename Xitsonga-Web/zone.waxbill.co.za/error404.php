...
<html ng-app>
	...
	<meta name="author" content="Waxbill">
        ...
        <title>404 &HorizontalLine; ClientZone</title>
    </head>
    <body>
        ...
        <div class="ts-main-content">
            <div class="wrapper" style ="background: #293A4A">
                <div class="container">
                    <div class="row">
                        <h1 style ="text-align: center;color:#F2F2F2">404</h1>
                        <h4 style ="text-align: center;color:#DBDBDB">COMPONENT NOT FOUND</h4>
                        <br/><br/>
                        <p style ="text-align: center;color:#F2F2F2">Looks like the page you are trying to visit doesn't exit.</p>
