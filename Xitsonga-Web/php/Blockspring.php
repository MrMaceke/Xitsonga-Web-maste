<?php
    ...
    class Blockspring {
      ...
      public function parse($input_params, $json_parsed = true) {
      ...
      public function run($block, $data = array(), $options = array()) {
      ...
      public function runParsed($block, $data = array(), $options = array()) {
        if (is_string($options)){
          $options = array(
            "api_key"=> $options,
            "cache"=> false,
      ...
      public function define($my_function = null){
