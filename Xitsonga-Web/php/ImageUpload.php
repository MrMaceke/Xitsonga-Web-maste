...
$destination_folder     = '../assets/images/entity/'; //upload directory ends with / (slash)
...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
    ...
    if($image_res){
        ...
        $image_name_only = $_POST['entity_id'];
        
        $new_file_name = "entity". '_' .$image_name_only. '' . ".jpg";
        
         //create a random name for new image (Eg: fileName_293749.jpg) ;
        require_once '../php/EntityDetailsDAO.php';
        require_once '../php/DTOUser.php';
        
        $aEntityDetails = new EntityDetailsDAO();
        
        $aDTOUser = unserialize($_SESSION['USER']);
        
        //$result = $aEntityDetails->addEntityImageDetail($new_file_name,$image_name_only,$aDTOUser->getUserID());
        ...
        if(normal_resize_image($image_res, $image_save_folder, $image_type, $max_image_size, $image_width, $image_height, $jpeg_quality))
        {
            ...
            echo '<img width="200" src="'."assets/images/entity/". $new_file_name.'" />';
        }
