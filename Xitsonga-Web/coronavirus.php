<?php
    ...
    $sk = isset($_REQUEST['sk'])? $_REQUEST['sk']:"Coronavirus";
    $item = isset($_REQUEST['_']) && $_REQUEST['_'] != ""? $_REQUEST['_']:"xitsongwatsongwana_xa_coronavirus"; 
     
    if(!$aWebbackend->hasAccess($pageName) || true){
            ...
            <article class="col-md-8 maincontent right marginTablet" style ="margin-left: 0px">
                <div class="row">    
                    <div class="new_heading">
                        <h4><a href ='kaya'>Home</a> > Coronavirus</h4>
                    </div>
                </div>
