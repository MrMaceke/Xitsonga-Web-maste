        ...
        <header id="head">
            <div class="container">
                <div class="row">
                    ...
                    <p style ="color:#424242">Simple REST API for dictionary translation of Xitsonga words to English and Xitsonga word lists.</p>
                   <br/>
                </div>
                <hr>
                <div class="row" style ="color:#424242">
                    ...
                    <div class="col-sm-2">
                        <input id ="word" style ="margin-right: 10px" class ='form-control' placeholder="Word">
                    </div>
                    <div class="col-sm-2">
