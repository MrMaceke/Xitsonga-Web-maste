...
<html ng-app>
	...
	<meta name="author" content="Waxbill">
        ...
        <title>Projects &HorizontalLine; ClientZone</title>
			...
			<div class="content">
                            <div class="module">
                                ...
                                <div class="module-body" style="min-height: 600px">
                                    <div ng-controller="clientProjectsController">
                                        <div ng-show="showLoader">
                                            <div style="height: 400px"></div>
                                        </div>
                                        <br/>
                                        <table id = 'projectTable' class="table table-bordered" cellspacing="0" width="100%">
                                            <tbody></tbody>
                                        </table>
                                        <div ng-if="projects.status === -999" ng-cloak>
