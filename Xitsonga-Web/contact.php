    ...
    <body class="home">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <article class="col-md-7 maincontent right marginTablet" style ="margin-left: 0px">
                    <div class="row">    
                    ...
                    <p>
                       Fill out the form below with some information about your query and we will get back to you as soon as we can. Please allow a couple days for us to respond.
                    </p>
                   <br/>
