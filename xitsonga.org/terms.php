        ...
        <div class="row">
            ...
            <article class="col-md-9 maincontent right marginTablet" style ="margin-left: 0px">
                ...
                <div class="rating_div" style ="margin-bottom: -20px">   
                    ...
                    <p>
                        The <a href ='about'>Xitsonga.org</a> logos and website content is a copyright of <a target ="_tab" href = 'https://www.facebook.com/sneidon'>Mukondli</a> &COPY; 2018. Feel free to copy and redistribute the web site content in any medium or format. Xitsonga.org cannot revoke these freedoms as long as you follow the license terms.
                    </p>
                    <ul>
                        <li><b>Attribution</b> — You must give appropriate credit, provide a link to this page, and indicate if changes were made. You may do so in any reasonable manner, but not in any way that suggests <a target ="_tab" href ="https://www.facebook.com/sneidon">Mukondli</a> endorses you or your use. </li>
                        <li><b>NonCommercial</b> — You may not use the material for <a target ="_tab" href ='https://creativecommons.org/licenses/by-nc-nd/2.0/#'>commercial purposes</a>.</li>
                   ...
                   <li>
                    ...
                    <p>
                        ...
                        <br/><br/>This policy is effective from 19 June 2018. 
                    </p>
                    <hr>
                    <br/>
            </article>
