<?php
    ...
    $sk = isset($_REQUEST['sk'])? $_REQUEST['sk']:"song-lyrics";
            ...
            <aside class="col-md-3 sidebar sidebar-left marginTablet">
                ...
                <div>
                    <form class ='basic_form'>
                        <div class="top-margin">
                            <input id ="word" type="text" class="form-control" placeholder="Search a song or joke">
                ...
                <div class="widget sub_links">
                    <ul class="list-unstyled list-spaces">
                        <li><a href="entertainment">Song lyrics</a></span></li>
                    </ul>
                    <ul class="list-unstyled list-spaces">
                        <li><a href="entertainment/jokes">Xitsonga jokes</a></span></li>
                    </ul>
                </div>
                <div class="row widget sub_heading">
                    <div class="col-xs-12">
                ...
                <div class="widget sub_links">
                    <ul class="list-unstyled list-spaces">
                        <li><a href="entertainment/poems">Poems</a></span></li>
                    </ul>
                    <ul class="list-unstyled list-spaces">
                        <li><a href="entertainment/traditional-food">Food recipes</a></span></li>
                    </ul>
                </div>
            </aside>
            <article class="col-md-6 maincontent">
                <div class="row">
                    <div class="new_heading">
                        <h4>
                            <?php
                                echo "<a href ='kaya'>Home</a> > <a href ='entertainment'>Entertainment</a> > ";
                ...
                <?php
                    if($item != NULL){
                        ...
                        if($sk == "song-lyrics") {
                            ...
                            echo "A collection of Xitsonga traditiona food recipes";
                            echo "<ul>";
