    ...
    class PageAccessController{
        ...
        public function PageAccessController($aUser) {
            ...
            $this->pages = array (
                            ...
                            "api" => $this->returnArrayForPage($this->BASIC_ACCESS,$aUser,"Xitsonga Dictionary API &mdash; a simple RESTful dictionary API"),
                            ...
                            "entertainment" => $this->returnArrayForPage($this->BASIC_ACCESS,$aUser,"Entertainment - Xitsonga.org"),
                    ...
                    $this->meta = array (
                            ...
                            "people" => $this->returnArrayForMeta("Xitsonga names, surnames & more",""),
            ...
            if($data == NULL or $aPageName =="manage" or $aPageName == "profile" or $aPageName == "membership"){
                ...
                if($aResult['status']){
                    ...
                    if($aResultTemp[status]){
                        ...
                        if($subtile == "-" OR strip_tags($aResultTemp[resultsArray][content]) != $aResultTemp[resultsArray][content]){
